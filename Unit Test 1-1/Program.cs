        ...
        start:
            ...
            for (nCntr = 0; nCntr < nQuestions; ++nCntr)
            {
                ...
                else if (nOp == 2)
                {
                    ...
                    nAnswer = Math.Round(dVal1 / dVal2, 2) ;
                    sQuestions = $"Question #{nCntr + 1}: {dVal1} / {dVal2}: please answer to two decimal places. =>";
                }
                else
                {
                    nAnswer = val1 * val2;
                ...
                do
                {
                    ...
                    {
                        Console.WriteLine("Please enter a number to 2 decimal places.");
                        bValid = false;
                    }
                } while (bValid == false);
                //} while (!bValid) ;
