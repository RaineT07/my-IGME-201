...
namespace Unit_test_1_12
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(dSalary); debug line
        ...
        //GiveRaise: checks if the first parameter, the name, is the same as the Author's name (Raine Taber) and gives them a raise if so, before returning true or false based on
        //if the user's name is the same.
