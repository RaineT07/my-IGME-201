    ...
    public partial class PersonEditForm : Form
    {
        ...
        public PersonEditForm(Person person, Form parentForm)
        {
            ...
            */
            ...
            if(person.GetType()==typeof(Student))
            {
                ...
                else if (student.eCollegeYear.Equals(collegeYear.freshman))
                {
                    froshRadioButton.Checked = true;
                }
                else if (student.eCollegeYear.Equals(collegeYear.sophomore))
                {
                    sophRadioButton.Checked = true;
                }
                else if (student.eCollegeYear.Equals(collegeYear.junior))
                {
        ...
        private void TypeComboBox__SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if(cb.SelectedIndex == 0 )
            {
                ...
                //lines 260 through 268 are the ones that do not work!!!
                ...
                //set classGroup box visible and enabled field = true
            ...
            else
            {
                ...
                //set classGroupbox visible and enabled field = false
        ...
        {
            //radio button ref variable is made
            RadioButton rb = (RadioButton)sender;
            //if rb is checked, then it will then check which of the 4 class radio buttons are checked and update
            //the label at the bottom of the group box with the correct class year
            if(rb.Checked==true)
            {
                if (froshRadioButton.Checked) { this.classOfLabel.Text = "Class of 2024"; }
